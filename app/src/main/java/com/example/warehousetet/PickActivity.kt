...
//        credentialManager = CredentialManager(this)
//        odooXmlRpcClient = OdooXmlRpcClient(credentialManager)
//        viewModel = PickViewModel(odooXmlRpcClient, CoroutineScope(Dispatchers.IO))
//
//        emptyStateLayout = findViewById(R.id.emptyStateLayout)
//
//        initializeRecyclerView()
...
//                startActivity(intent)
//            }
//            viewModel.fetchAndLogBuyerDetails(pick.name)
//        }
//        recyclerView.adapter = pickAdapter
//    }
//
...
class PickActivity : AppCompatActivity() {
    ...
    private lateinit var credentialManager: CredentialManager
    private lateinit var emptyStateLayout: LinearLayout
    private val viewModel: PickViewModel by viewModels { PickViewModelFactory(odooXmlRpcClient) }
    private var isSearching = false
