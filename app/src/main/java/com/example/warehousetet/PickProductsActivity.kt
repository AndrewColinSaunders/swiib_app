...
//    private fun setupRecyclerView() {
//        val recyclerView: RecyclerView = findViewById(R.id.pickProductsRecyclerView)
//        pickProductsAdapter = PickProductsAdapter(emptyList(), quantityMatches, pickId, this)
//        recyclerView.layoutManager = LinearLayoutManager(this)
//        recyclerView.adapter = pickProductsAdapter
//    }
private fun setupRecyclerView() {
...
//
//        // Determine the product's tracking type and lotName has a value
//        coroutineScope.launch {
//            val trackingAndExpiration = odooXmlRpcClient.fetchProductTrackingAndExpirationByName(product.productName)
//            val trackingType = trackingAndExpiration?.first ?: "none"
//
//            withContext(Dispatchers.Main) {
//                // Toggle the visibility for editing the lot number based on tracking type and lotName being non-empty
...
//                product.lotName = editTextProductLotNumber.text.toString()
//                textProductLotNumber.text = "${product.lotName}"
//            }
//            dialog.dismiss()
//        }
...
//    private fun updateUIForProducts(moveLines: List<MoveLine>, pickId: Int) {
//        // Assuming updateUIForProducts takes a list of MoveLine and updates the RecyclerView adapter
//        pickProductsAdapter.updateProducts(moveLines, pickId, quantityMatches)
//        Log.d("PickProductsActivity", "Adapter updated with new products.")
//    }
